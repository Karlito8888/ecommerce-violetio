    ...
    bags: [
      {
        ...
        items: [
          { id: "item-1", skuId: "sku-1", productId: "", quantity: 2, unitPrice: 1999 },
          { id: "item-2", skuId: "sku-2", productId: "", quantity: 1, unitPrice: 4999 },
        ],
        subtotal: 8997,
        tax: 0,
        shippingTotal: 0,
      ...
      bags: [
        {
          ...
          merchantId: "m-1",
          merchantName: "M1",
          items: [{ id: "i1", skuId: "sku-1", productId: "", quantity: 3, unitPrice: 1000 }],
          subtotal: 3000,
          tax: 0,
          shippingTotal: 0,
          errors: [],
        },
        {
          ...
          merchantName: "M2",
          items: [
            { id: "i2", skuId: "sku-2", productId: "", quantity: 2, unitPrice: 2000 },
            { id: "i3", skuId: "sku-3", productId: "", quantity: 1, unitPrice: 500 },
          ],
          subtotal: 4500,
          tax: 0,
          shippingTotal: 0,
